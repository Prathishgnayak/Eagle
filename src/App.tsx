...
const App = () => {
  ...
  useEffect(() => {
    ...
    //   channelId: 'default', // This must match the channel created in Java
    ...
    PushNotification.localNotification({
      ...
      bigPictureUrl: 'https://socializing123.s3.ap-south-1.amazonaws.com/Image_20241004_092402_832-copy.jpeg', // (optional) default: undefined
      ...
      picture: 'https://socializing123.s3.ap-south-1.amazonaws.com/Image_20241004_092402_832-copy.jpeg', // (optional) Display an picture with the notification, alias of `bigPictureUrl` for Android. default: undefined
